...
def dataset1():
    ...
    if 'dataset1_image' not in st.session_state or st.button('Randomize Image', key='randomize1'):
...
def dataset2():
    ...
    if 'dataset2_image' not in st.session_state or st.button('Randomize Image', key='randomize2'):
